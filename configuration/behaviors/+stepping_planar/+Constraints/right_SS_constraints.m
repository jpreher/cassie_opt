...
%         v_target, v_target,'Nonlinear');
    ...
    %% nsf XY plane position
    p_left_foot_fun = SymFunction(['nsf_planar_position_', domain.Name], p_left_foot(1:2), {x});
    addNodeConstraint(nlp, p_left_foot_fun, {'x'}, 'all',   [-0.5, 0.1], ...
                                                            [ 0.5, 0.30], 'Nonlinear');
    addNodeConstraint(nlp, p_left_foot_fun, {'x'}, 'first', [-0.5,  0.15], ...
                                                            [-0.20, 0.30], 'Nonlinear');
    addNodeConstraint(nlp, p_left_foot_fun, {'x'}, 'last',  [0.20, 0.15], ...
                                                            [0.5,  0.30], 'Nonlinear');
