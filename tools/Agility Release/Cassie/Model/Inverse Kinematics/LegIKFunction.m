...
classdef LegIKFunction < Function %#codegen
  ...
  methods (Access = public)
    ...
    function [] = setDesiredFootTransforms(obj, LeftFoot, RightFoot)
        % Set the desiredState based on target transoforms
        
        obj.leftFootTransform  = LeftFoot;
        obj.rightFootTransform = RightFoot;
    end
